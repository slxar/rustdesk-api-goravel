...
func (g *Group) Users(c *gin.Context) {
	...
	if !*u.IsAdmin && gr.Type != model.GroupTypeShare {
		...
		userList = service.AllService.UserService.ListByGroupId(u.GroupId, q.PageNumber(), q.PageSize)
	}
...
func (g *Group) Peers(c *gin.Context) {
	...
	peerList := service.AllService.PeerService.ListByUserIds(userIds, q.PageNumber(), q.PageSize)

...
import (
	...
	_ "github.com/slxar/rustdesk-api-goravel/v3/docs/api"
	"github.com/slxar/rustdesk-api-goravel/v3/global"
	"github.com/slxar/rustdesk-api-goravel/v3/http/controller/api"
...
func ApiInit(g *gin.Engine) {
	...
	// 加载 HTML 模板
	g.LoadHTMLGlob(frameworkpath.Resource("templates", "*"))
	...
	frg.POST("/webclient/access-tokens", middleware.WebAccessAuth(), api.MintWebAccess)
...
func PersonalRoutes(frg *gin.RouterGroup) {
	{
		ab := &api.Ab{}
		frg.GET("/ab/personal", ab.Personal)

/* eslint-disable */
// LoginRequest.version (11) and FileTransferReceiveRequest.total_size (5)
// match RustDesk 1.4.9 hbb_common 7e1c392c62d39c364127307cd408421dd5f8cfb0.
...
export const LoginRequest = {
  encode(message: LoginRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.version !== "") writer.uint32(90).string(message.version);
    return writer;
  },
...
function createBaseFileTransferReceiveRequest(): FileTransferReceiveRequest {
  return { total_size: 0, id: 0, path: "", files: [], file_num: 0 };
}
...
export const FileTransferReceiveRequest = {
  encode(message: FileTransferReceiveRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.total_size !== 0) writer.uint32(40).uint64(message.total_size);
    return writer;
  },
